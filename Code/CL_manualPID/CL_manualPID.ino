/* PROGRAM MENGAMBIL REFERENSI DARI MANUAL PID
 * https://www.semesin.com/project/2018/03/13/sistem-kontrol-pid-dengan-arduino/
 * https://www.teachmemicro.com/arduino-pid-control-tutorial/#:~:text=To%20implement%20a%20PID%20controller,be%20determining%20the%20time%20elapsed.
 */
//[0] Library
...
//[5] Regresi Flow & Step valve
      float x = literPermenit;
      float y = 4247.36 - 134.84*x;
      step_valve = y;
